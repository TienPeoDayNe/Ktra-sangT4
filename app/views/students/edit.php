...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo URLROOT; ?>/students/edit/<?php echo $data['masv']; ?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="current_image" value="<?php echo $data['hinh']; ?>">
                    <div class="form-group mb-3">
                        <label for="masv">Mã sinh viên:</label>
                        <input type="text" class="form-control" value="<?php echo $data['masv']; ?>" readonly>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <?php if($data['hinh']) : ?>
                            <div class="mb-2">
                                <img src="<?php echo URLROOT . '/' . $data['hinh']; ?>" 
                                     alt="<?php echo $data['hoten']; ?>" 
